...
- Django
    ...
    - View
        - [Generic View](./server/django/django_generic_view.md)
        - [Generic Display View](./server/django/django_generic_display_view.md)
        - [Generic Edit View](./server/django/django_generic_edit_view.md)
...
- [데이터의 의의와 데이터 분석 개요](./da/데이터의%20의의와%20데이터%20분석%20개요.md)
...
- [보험 의료비 예측 모델링](./mldl/보험%20의료비%20예측%20모델링.md)
- [미세먼지 농도 예측 데이터 분석](./mldl/미세먼지%20농도%20예측%20데이터%20분석.md)
- [미세먼지 농도 예측 모델링](./mldl/미세먼지%20농도%20예측%20모델링.md)
- [장애인 콜택시 대기시간 예측 데이터 전처리](./mldl/장애인%20콜택시%20대기시간%20예측%20데이터%20전처리.md)
...
- [딥러닝 다중분류: MNIST](./mldl/딥러닝%20다중분류%20MNIST.md)
- [딥러닝 성능 관리](./mldl/딥러닝%20성능%20관리.md)
- [Functional API](./mldl/Functional_API.md)
- [딥러닝 시계열 모델링: SimpleRNN, LSTM](./mldl/Time_Series_RNN_LSTM.md)
...
- [RNN](./mldl/RNN.md)
- [GAN](./mldl/GAN.md)
- [Reinforcement Learning](./mldl/Reinforcement_Learning.md)
- [LLM](./mldl/LLM.md)
